...
<p align="center">
  <a href="https://devtools.at/tools/bcrypt-generator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Generate bcrypt password hashes</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/bcrypt-generator">Try Online</a> •
...
**[Try Bcrypt Generator online at DevTools.at →](https://devtools.at/tools/bcrypt-generator)**
...
Generate bcrypt password hashes. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/bcrypt-generator';
